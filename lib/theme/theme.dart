...
class CustomColors {
  ...
  static Color pageBackgoundColor = Color(0xFF2D2F41);
  static Color menuBackgoundColor = Color(0xFF242634);
...
class GradientColors {
  ...
  static List<Color> sunset = [Color(0xFFFE6197), Color(0xFFFF8463)];
  static List<Color> sea = [Color(0xFF61A3FE), Color(0xFF63FFD5)];
  static List<Color> mango = [Color(0xFFFFA738), Color(0xFFFFE130)];
  static List<Color> fire = [Color(0xFFFF5DCD), Color(0xFFFF8484)];
  static List<Color> firy = [Color(0xFFFF5DCD), Color(0xFFFF8484)];
}
